...
public class PropertySafeService {
    ...
    public PropertySafeService(Web3j web3client, Credentials credentials, ContractGasProvider gasProvider, PropertySafe propertySafe) {
    ...
    public BigInteger deployPropertyToSafe(String externalPropertyId, String propertyName, int propertyValue) {
        try {
            ...
            Property property = Property.deploy(web3client, credentials, gasProvider, propertyName, BigInteger.valueOf(propertyValue)).send();
    ...
    public String deployPropertySafe() {
        try {
            PropertySafe deployedPropertySafe = PropertySafe.deploy(web3client, credentials, gasProvider).send();
    ...
    public List<PropertyModel> listPropertySafe() {
        try {
            ...
            for(String addr : propertyList){
                Property p = Property.load(addr, web3client, credentials, gasProvider);
